effect effects/weapons/rocketlauncher/fly
{
	...
	emitter "trail4"
	{
		...
		sprite
		{
			duration	1,1
			persist
			material	"gfx/effects/smoke/cloud_alpha2wide"
	...
	emitter "firetrail4"
	{
		...
		sprite
		{
			duration	0.1,0.1
			persist
			material	"gfx/effects/fire/firewide"
	...
	emitter "side_streaks4"
	{
		...
		line
		{
			duration	0.3,0.3
			blend	add
			material	"gfx/effects/weapons/flash_halfwide"
	...
	spawner "flash4"
	{
		...
		{
			duration	1,1
			material	"gfx/effects/weapons/flashwide"
